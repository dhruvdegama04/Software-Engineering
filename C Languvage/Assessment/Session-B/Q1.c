...
Print the assigned grade and a one-line message for each band (e.g., 'B â€” Good work! Keep
pushing.').
Handle invalid input: if the score is outside the range 0â€“100, print a clear error message and
